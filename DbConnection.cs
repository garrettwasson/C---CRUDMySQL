...
namespace DbConnection
{
    public class DbConnector
    {
        ...
        static string db = "consoleDB"; //Change to your schema name; located in the .mwb file
        static string port = "3306"; //Potentially 8889
        static string user = "root";
        static string pass = "Fenrir666"; //My custom password; generally default to 'root'
